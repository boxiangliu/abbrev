...
cat ../processed_data/preprocess/ab3p/summarize_ab3p/ab3p_freq.csv | python3 preprocess/character_rnn/data/ab3p2pos.py | sort -t$'\t' -k1,1 -k2,2 > ../processed_data/preprocess/character_rnn/data/pos
